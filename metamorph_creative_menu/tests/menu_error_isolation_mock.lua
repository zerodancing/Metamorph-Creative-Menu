...
local stubs = {
    ...
    ["mods/metamorph_creative_menu/files/platform/noita/keycodes.lua"]={resolve=function() return 9 end},
...
local tab_paths = {
    "spells.lua","items.lua","perks.lua","creatures.lua","effects.lua","weather.lua","world_rules.lua"
}
