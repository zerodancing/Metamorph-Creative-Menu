...
local requested_path = "data/entities/animals/vault/scavenger_smg.xml"
local actual_path = "data/entities/animals/scavenger_smg.xml"
...
function EntityGetName(entity) return entity == 2 and "vault_scavenger" or "" end
...
frame = frame + 1
possession.update()
assert(retirement_calls == 1 and target_alive == false, "original vault mob was not removed after confirmed fallback form")
print("possession_replacement=PASS fallback_actual_target=true original_retired=true requested_identity_preserved=true")
