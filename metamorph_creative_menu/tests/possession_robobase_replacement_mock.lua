...
local requested_path = "data/entities/animals/robobase/monk.xml"
local actual_path = "data/entities/animals/monk.xml"
...
function EntityGetName(entity) return entity == 2 and "robobase_monk" or "" end
...
frame = frame + 1
possession.update()
assert(retirement_calls == 1 and target_alive == false, "original robobase mob was not removed after confirmed fallback form")
print("possession_robobase_replacement=PASS fallback_actual_target=true original_retired=true requested_identity_preserved=true")
